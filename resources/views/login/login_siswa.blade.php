                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 " style="background-color:#1AA222;">
                                <div class="p-5">
                                    ...
                                    <h1 class="h4 text-white mb-4">Welcome Back (Siswa)!</h1>
                                    </div>
                                    ...
                                    @endif
                                    <form class="user" method="POST" action="{{ route('login_siswa.action') }}">
                                        @csrf
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small text-white" href="/register_lainnya">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
