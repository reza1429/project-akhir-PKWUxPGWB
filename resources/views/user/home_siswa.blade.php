                        ...
                        <tbody>
                            @forelse($siswa as $i => $siswa)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-info btn-circle" data-toggle="modal" data-target="#modal-detail{{$siswa->id}}">
                                            <i class="fa fa-info" aria-hidden="true"></i> 
                                        </button>
                                    </td>
                                </tr>
                            @empty
                            <p>siswa belum pernah masuk uks</p>
                            @endforelse
                        </tbody>
                        </table>
                </div>
